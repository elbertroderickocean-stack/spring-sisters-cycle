    ...
    <Card>
      <CardHeader className="pb-2">
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-sm font-bold">Impact on Skin Portfolio</CardTitle>
        </div>
      </CardHeader>
      <CardContent className="space-y-3">
        ...
        <div className="p-3 rounded-xl bg-accent border-[0.5px] border-[hsl(var(--glass-border))]">
