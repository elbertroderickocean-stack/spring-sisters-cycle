...
export const articles: Record<string, Article> = {
  'mission': {
    ...
    bodyTextCellular: "The modern woman's bathroom shelf is often a 'graveyard of bottles.' We believe beauty is not a fight against time, but a dance in harmony with your body's wisdom. When you understand your new rhythm, you stop blaming yourself and start understanding yourself. Our mission is to restore that harmony through knowledge, ritual, and a system that finally makes sense."
  },
  'lines': {
    id: 'lines',
    title: 'Our Ecosystem: The Sun, The Planets, and The Meteorites',
    heroImage: '/images/lines-hero.jpg',
    bodyText: "Our system works like an orbit.\n\n☀️ The The Constants™ Line is The Sun. It is the stable, gravitational center of your routine. These are the constants—your cleanser, moisturizer, and eye cream—that provide balance and protection every single day, regardless of your cycle. Cycle changes. Harmony stays.\n\n🌙 The The Shifts™ Line is The Planets. These are the variables, moving in predictable orbits. This is the intelligent heart of our system—our serums, masks, and peels that adapt to your hormonal phases, working ahead of the curve to prevent problems before they start. Your skin has phases. Now your care does too.\n\n⚡ The The Assets™ Line is The Meteorites. These are the surgical tools, the instant problem-solvers. They appear exactly when needed to handle an acute issue, like a sudden breakout or irritation. They are not for every day; they are for targeted, powerful intervention. When your skin calls for help—precision answers.",
    bodyTextCellular: "Our system works like an orbit.\n\n☀️ The The Constants™ Line is The Sun. It is the stable, gravitational center of your routine. These are the constants—your cleanser, moisturizer, and eye cream—that provide balance and protection every single day, regardless of your cycle. Cycle changes. Harmony stays.\n\n🌙 The The Shifts™ Line is The Heart of Your Training. These are the core 'exercises' in your 7-day cellular training rhythm, delivering targeted signals for recovery, activation, and balance exactly when your skin needs them.\n\n⚡ The The Assets™ Line is The Meteorites. These are the surgical tools, the instant problem-solvers. They appear exactly when needed to handle an acute issue, like a sudden breakout or irritation. They are not for every day; they are for targeted, powerful intervention. When your skin calls for help—precision answers."
  },
  'phase-calm': {
    id: 'phase-calm',
